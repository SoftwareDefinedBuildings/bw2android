...
DEST_FILE = "../java/edu/berkeley/cs/sdb/bosswave/POAllocations.java"
INDENT_UNIT = "    "
...
if __name__ == '__main__':
    ...
    with open(DEST_FILE, 'w') as f:
        ...
        for key, params in allocs.iteritems():
            ...
            f.write(INDENT_UNIT + 'public static final int PONum{} = {};\n'.format(sym_name, po_num))
            f.write(INDENT_UNIT + 'public static final String PODFMask{} = "{}";\n'.format(sym_name, key))
            f.write(INDENT_UNIT + 'public static final byte[] PODF{} = {{{}}};\n'.format(sym_name, ', '.join(po_df)))
            f.write(INDENT_UNIT + 'public static final int POMask{} = {};\n'.format(sym_name, mask))
            f.write('\n')
